...
description: |
  **BitStat**는 **R 패키지**로, 통계 기반의 데이터 분석을 UI/UX로 지원하는 **shiny 웹앱**으로 쉬운 한글 메뉴와 글로벌 영문 메뉴를 지원합니다.
...
<img class="img-concert" src="img/help.png" alt="도움말 화면" width="600" height="417"/>
